...
const ChatContainer = () => {
  ...
  // fetch messages & subscribe to socket when selectedUser changes
  useEffect(() => {
  ...
  }, [selectedUser?._id, socket, getMessages, selectedUser, subscribeToMessages, unsubscribeFromMessages]);
